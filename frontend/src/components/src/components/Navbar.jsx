      ...
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm ">
        <div className="max-w-7xl mx-auto px-6 md:px-12 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <ShoppingCart className="w-[26px] h-[26px] transition-transform duration-300 group-hover:scale-105" />
              {count > 0 && (
            ...
            <Link
              ...
              className="group p-2.5 rounded-full text-gray-500
                         ...
                         active:scale-95"
            >
              <CircleUserRound className="w-[26px] h-[26px] transition-transform duration-300 group-hover:scale-105" />
            </Link>
