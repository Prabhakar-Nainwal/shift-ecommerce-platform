...
export default function Footer() {
  return (
    <footer className="w-full text-white/70 relative mt-20">
      {/* Wavy Top SVG Boundary */}
      <div className="absolute top-0 left-0 right-0 w-full overflow-hidden leading-[0] transform -translate-y-[99%]">
        ...
        >
          <path
            d="M0 50C240 70 480 80 720 50C960 20 1200 -10 1440 10V74H0V50Z"
            fill="#23242A"
          />
        </svg>
      </div>

      {/* Main Footer Container with Charcoal Gray Background */}
      <div className="bg-[#23242A] pt-8 pb-12">
        {/* Main content - exact original grid structure */}
        <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-2 md:grid-cols-6 gap-x-8 gap-y-12">
          ...
          <div className="col-span-2 md:col-span-2 pr-4">
            <div className='font-sans text-sm font-black uppercase tracking-[0.2em] transition-all duration-300'>
              ...
              <span className="text-[#E26344]">IFT</span>
            </div>

            <p className="mt-4 text-sm leading-relaxed text-white/50 max-w-[26ch]">
            ...
            <div className="flex gap-4 mt-6">
              {[
                ...
                <a
                  ...
                  className="text-white/40 hover:text-[#E26344] transition-colors"
                >
          ...
          <div className="col-span-1">
            <h3 className="text-xs font-semibold uppercase tracking-[0.12em] text-white/40 mb-4">
              Shop
            </h3>
            <ul className="space-y-3 text-sm">
              <li><Link to="/" className="text-white/70 hover:text-[#E26344] transition-colors">Home</Link></li>
              <li><Link to="/shop" className="text-white/70 hover:text-[#E26344] transition-colors">All Products</Link></li>
              <li><Link to="/new" className="text-white/70 hover:text-[#E26344] transition-colors">New Arrivals</Link></li>
              <li><Link to="/cart" className="text-white/70 hover:text-[#E26344] transition-colors">Cart</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to="/contact" className="text-white/70 hover:text-[#E26344] transition-colors">Contact Us</Link></li>
              <li><Link to="/shipping" className="text-white/70 hover:text-[#E26344] transition-colors">Shipping</Link></li>
              <li><Link to="/returns" className="text-white/70 hover:text-[#E26344] transition-colors">Returns</Link></li>
              <li><Link to="/faq" className="text-white/70 hover:text-[#E26344] transition-colors">FAQ</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to="/about" className="text-white/70 hover:text-[#E26344] transition-colors">About</Link></li>
              <li><Link to="/journal" className="text-white/70 hover:text-[#E26344] transition-colors">Journal</Link></li>
              <li><Link to="/careers" className="text-white/70 hover:text-[#E26344] transition-colors">Careers</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="mailto:hello@SHIFT.store" className="text-white/70 hover:text-[#E26344] transition-colors">
                  hello@SHIFT.store
                </a>
              </li>
              <li>
                <a href="tel:+15550123456" className="text-white/70 hover:text-[#E26344] transition-colors">
                  +1 (555) 012-3456
                </a>
              </li>
              <li className="text-white/40">Mon–Fri, 9am–6pm</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10">
          <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col-reverse md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-6 text-xs text-white/40">
              <Link to="/privacy" className="hover:text-[#E26344] transition-colors">Privacy Policy</Link>
              <Link to="/terms" className="hover:text-[#E26344] transition-colors">Terms of Service</Link>
            </div>

            <div className="flex gap-3 text-[11px] tracking-wide text-white/30 font-medium">
              <span>VISA</span>
